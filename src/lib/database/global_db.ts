...
const tediumData: TediumData = {
  About: {
    ...
    Description: `What does a workday with a large language model actually look like, hour after hour, prompt after prompt?<br><br>
      ...
      <i>Tedium</i> tests the narratives of AI hype against the grain of everyday work. It traces how those narratives shape practice, inscribing themselves into routines that, up close, prove messy, recursive, deceptive, and tedious.`,
  },
  Team: [
    {
