        ...
        >
            <div class="flex h-10 w-full items-center justify-between bg-white">
                {#key $sharingTextMobile}
                    <p
                        class="min-w-[10rem] flex-1 overflow-hidden text-base text-center md:text-left"
                    >
                        {#if $isDesktop}
                            Sharing "{$shareInfo.exTitle &&
                            $shareInfo.exTitle.length > 20
                ...
                {#if $isDesktop}
                    ...
                    >
                        <svg
                            class="h-9 w-9 fill-black transition duration-150 ease-in-out group-hover:scale-110"
            ...
            <div
                class="hidden w-full items-center justify-between gap-4 md:flex"
            >
                <button
                    type="button"
            ...
            <div
                class="hidden w-full items-center justify-between gap-3 md:flex"
            >
                <div
                    class="flex-1 overflow-hidden rounded-xl border border-black bg-white text-black"
                >
                    <p
                        class="flex h-10 w-full select-text items-center justify-center px-2 text-xs text-center selection:bg-black selection:text-white"
                    >
                        {"ecologiesofllm.medialab.sciencespo.fr/" +
                            $currentHash}
                    </p>
                </div>
                <button
                ...
                >
                    ...
                    >
                        <p class="text-[11px] text-center text-black">
                            Link copied!
                        </p>
                    </div>
                </button>
