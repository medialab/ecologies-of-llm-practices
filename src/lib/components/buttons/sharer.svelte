...
{#if $showSharer}
    <div class="fixed inset-0 z-[1000] flex items-center justify-center px-4">
        <div
            class="relative md:w-1/4 w-full h-fit md:aspect-video flex flex-col gap-3 rounded-xl border border-black bg-white py-2 px-4 fill-black transition-all duration-500 ease-in-out z-[300]"
            in:scale={{ duration: 400, delay: 200, start: 0, opacity: 0 }}
            out:scale={{ duration: 400, delay: 200, start: 0, opacity: 0 }}
            aria-modal="true"
            role="dialog"
            tabindex="0">
            <div class="flex h-10 w-full items-center justify-between bg-white">
                {#key $sharingTextMobile}
                    <p class="min-w-[10rem] flex-1 overflow-hidden text-base text-center md:text-left">
                        {#if $isDesktop}
                ...
                {#if $isDesktop}
                    <button
                        ...
                        class="group flex h-10 w-10 items-center justify-center rounded-full border-0 bg-transparent p-0 transition duration-150 ease-in-out active:scale-90">
                        <svg class="h-9 w-9 fill-black transition duration-150 ease-in-out group-hover:scale-110" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path d="M256-227.69 227.69-256l224-224-224-224L256-732.31l224 224 224-224L732.31-704l-224 224 224 224L704-227.69l-224-224-224 224Z"/></svg>
                    </button>
            ...
            <div class="hidden w-full items-center justify-between gap-4 md:flex">
                ...
                <button type="button" id="reddit_sharer" onclick={shareOnReddit} aria-label="Share on Reddit" class="sharer_icon">
                    <svg class="h-full w-full fill-black" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 280 280">
                ...
                <button type="button" id="download_sharer" onclick={downloadImage} aria-label="Download image" class="sharer_icon">
                    <svg class="h-full w-full fill-black" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path d="m481.07-394.98-57.59 57.59 60.3 60.3 161-161-161-161-60.3 60.31 57.59 57.58H317.13v86.22h163.94Zm-318.2 243.11q-37.78 0-64.39-26.61t-26.61-64.39v-474.26q0-37.78 26.61-64.39t64.39-26.61h233.54L480-724.54h317.13q37.78 0 64.39 26.61 26.61 26.6 26.61 64.39v390.67q0 37.78-26.61 64.39t-64.39 26.61H162.87Zm0-91h634.26v-390.67H442.46l-83.59-83.59h-196v474.26Zm0 0v-474.26 474.26Z"/></svg>
                </button>
                <button type="button" id="bluesky_sharer" onclick={shareOnBluesky} aria-label="Share on Bluesky" class="sharer_icon">
                    <svg class="h-full w-full fill-black" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 318 280">
            ...
            <div class="hidden w-full items-center justify-between gap-3 md:flex">
                <div class="flex-1 overflow-hidden rounded-xl border border-black bg-white text-black">
                    <p class="flex h-10 w-full select-text items-center justify-center px-2 text-xs text-center selection:bg-black selection:text-white">
