...
function Capitols($$payload, $$props) {
  ...
  $$payload.out += `<section class="card_container svelte-gl6r8h" draggable="true" aria-label="Draggable Card"${attr("data-section", card.Title)}><div class="card_container_inner svelte-gl6r8h"${attr_style(`transition: transform ${stringify(transitionTime)}s var(--transition-curve) ${stringify(transitionDelay)}ms;`)}><img data-sveltekit-preload-data="" class="card_corner_logo svelte-gl6r8h"${attr("src", condensed_logo)} style="z-index: 5;" alt="EL2MP Logo"> <div class="description_container svelte-gl6r8h"${attr_style(`background-color: ${stringify(card.bgColor)}; border: 5px solid ${stringify(card.bgColor)};`)}><h1 class="h1 svelte-gl6r8h" style="z-index: 7;">${html(card.Title)}</h1></div> <div class="card_scrollable_container svelte-gl6r8h" data-simplebar="" data-simplebar-auto-hide="false"${attr("data-section", card.Title)}><div class="card_scroll_flex svelte-gl6r8h"${attr("data-section", card.Title)}><p class="p1 svelte-gl6r8h" id="description">${html(card.Question)}</p> `;
  if (card.Description) {
    $$payload.out += "<!--[-->";
    $$payload.out += `<p class="p3 svelte-gl6r8h" id="description">${html(card.Description)}</p>`;
  } else {
    $$payload.out += "<!--[!-->";
  }
  $$payload.out += `<!--]--> `;
  if (card.CoverImg) {
    $$payload.out += "<!--[-->";
    $$payload.out += `<div class="cover_image_container svelte-gl6r8h"><div class="overlay_filter svelte-gl6r8h"${attr_style(`background-color: ${stringify(card.bgColor)};`)}></div> `;
    if (typeof card.CoverImg === "string") {
      $$payload.out += "<!--[-->";
      $$payload.out += `<img data-sveltekit-preload-data=""${attr("src", card.CoverImg.img.src)} alt="CoverImg" class="cover_image svelte-gl6r8h"${attr("width", card.CoverImg.img.w)}${attr("height", card.CoverImg.img.h)}>`;
    } else {
      $$payload.out += "<!--[!-->";
      const each_array = ensure_array_like(Object.entries(card.CoverImg.sources));
      $$payload.out += `<picture class="svelte-gl6r8h"><!--[-->`;
      for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
        let [format, srcset] = each_array[$$index];
        $$payload.out += `<source${attr("srcset", srcset)}${attr("type", "image/" + format)} class="svelte-gl6r8h">`;
      }
      $$payload.out += `<!--]--> <img data-sveltekit-preload-data=""${attr("src", card.CoverImg.img.src)} alt="CoverImg" class="cover_image svelte-gl6r8h"${attr("width", card.CoverImg.img.w)}${attr("height", card.CoverImg.img.h)}></picture>`;
    }
    $$payload.out += `<!--]--></div>`;
  } else {
    $$payload.out += "<!--[!-->";
  ...
  if (each_array_1.length !== 0) {
    ...
    for (let index = 0, $$length = each_array_1.length; index < $$length; index++) {
      ...
      $$payload.out += `<div class="section_container svelte-gl6r8h" data-sveltekit-preload-data=""${attr("data-section", `Ex ${index + 1}`)}>`;
      if (section.title) {
        $$payload.out += "<!--[-->";
        $$payload.out += `<h2 class="svelte-gl6r8h">${html(section.title)}</h2>`;
      } else {
        $$payload.out += "<!--[!-->";
      }
      $$payload.out += `<!--]--> `;
      if (section.subtitle) {
        $$payload.out += "<!--[-->";
        $$payload.out += `<p class="p3 svelte-gl6r8h" exercise-description="">${html(section.subtitle)}</p>`;
      } else {
        $$payload.out += "<!--[!-->";
      }
      $$payload.out += `<!--]--> `;
      if (section.picture) {
        ...
        if (typeof section.picture === "string") {
          $$payload.out += "<!--[-->";
          $$payload.out += `<img data-sveltekit-preload-data="" class="article_image svelte-gl6r8h"${attr("src", section.picture.img.src)} alt="People"${attr("width", section.picture.img.w)}${attr("height", section.picture.img.h)}>`;
        } else {
          $$payload.out += "<!--[!-->";
          ...
          $$payload.out += `<!--]--> <img data-sveltekit-preload-data="" class="article_image svelte-gl6r8h"${attr("src", section.picture.img.src)} alt="People"${attr("width", section.picture.img.w)}${attr("height", section.picture.img.h)}></picture>`;
        }
        $$payload.out += `<!--]--></div>`;
      } else {
        $$payload.out += "<!--[!-->";
      ...
      if (section.text) {
        $$payload.out += "<!--[-->";
        $$payload.out += `<div class="double_column_text_article svelte-gl6r8h"><p class="p3 svelte-gl6r8h">${html(section.text)}</p></div>`;
      } else {
        $$payload.out += "<!--[!-->";
      }
      $$payload.out += `<!--]--></div>`;
    ...
    $$payload.out += "<!--[!-->";
    $$payload.out += `<p class="svelte-gl6r8h">If you see this we are encountering issues</p>`;
  }
  $$payload.out += `<!--]--></div></div> <img data-sveltekit-preload-data="" class="card_corner_logo svelte-gl6r8h"${attr("src", condensed_logo)} alt="EL2MP Logo"></div> <div${attr_class(`altergo_container_inner ${stringify(store_get($$store_subs ??= {}, "$isAlterEgoMode", isAlterEgoMode) ? "open" : "")}`, "svelte-gl6r8h")}${attr_style(`background-color: ${stringify(alterEgoCard.bgColor)} !important; transition: transform ${stringify(transitionTime)}s var(--transition-curve) ${stringify(transitionDelay)}ms;`)}><img data-sveltekit-preload-data="" class="card_corner_logo svelte-gl6r8h"${attr("src", condensed_logo_white)} alt="EL2MP Logo" style="z-index: 10;"> <div class="description_container svelte-gl6r8h"${attr_style(`background-color: ${stringify(alterEgoCard.bgColor)}; border: 5px solid ${stringify(alterEgoCard.bgColor)};`)}><h1 class="h1 svelte-gl6r8h" style="z-index: 7; line-height: 1;">${html(alterEgoCard.Title)}</h1></div> <div class="card_scrollable_container svelte-gl6r8h" data-simplebar="" data-simplebar-auto-hide="false"${attr("data-section", alterEgoCard.Title)}><div class="card_scroll_flex svelte-gl6r8h"${attr("data-section", alterEgoCard.Title)}><p class="p1 svelte-gl6r8h" id="description">${html(alterEgoCard.Question)}</p> `;
  if (alterEgoCard.Description) {
    $$payload.out += "<!--[-->";
    $$payload.out += `<p class="p3 svelte-gl6r8h" id="description">${html(alterEgoCard.Description)}</p>`;
  } else {
    $$payload.out += "<!--[!-->";
  }
  $$payload.out += `<!--]--> `;
  if (alterEgoCard.CoverImg) {
    ...
    if (typeof alterEgoCard.CoverImg === "string") {
      $$payload.out += "<!--[-->";
      $$payload.out += `<img data-sveltekit-preload-data=""${attr("src", alterEgoCard.CoverImg.img.src)} alt="CoverImg" class="cover_image_alterego svelte-gl6r8h"${attr("width", alterEgoCard.CoverImg.img.w)}${attr("height", alterEgoCard.CoverImg.img.h)}>`;
    } else {
      $$payload.out += "<!--[!-->";
      ...
      $$payload.out += `<!--]--> <img data-sveltekit-preload-data=""${attr("src", alterEgoCard.CoverImg.img.src)} alt="CoverImg" class="cover_image_alterego svelte-gl6r8h"${attr("width", alterEgoCard.CoverImg.img.w)}${attr("height", alterEgoCard.CoverImg.img.h)}></picture>`;
    }
    $$payload.out += `<!--]-->`;
  } else {
    $$payload.out += "<!--[!-->";
  }
  $$payload.out += `<!--]--></div></div> <img data-sveltekit-preload-data="" class="card_corner_logo svelte-gl6r8h"${attr("src", condensed_logo)} alt="EL2MP Logo"></div></section>`;
...
function _page($$payload, $$props) {
  ...
  $$payload.out += `<!--]--> <div class="mobile_desc_container svelte-1comt9d"><div class="mobile_description svelte-1comt9d"><p class="p2 svelte-1comt9d">${html(data.alterEgosDb.Card1.Description)}</p></div> <div class="mobile_description tip svelte-1comt9d"><p class="h4" style="text-align: center;">Try this website on a  💻  device.</p></div></div></section></div>`;
  if ($$store_subs) unsubscribe_stores($$store_subs);
